...
# out_dir <- "D:/Terra-Informatix/Richael-Ghana/Spneumo-WGS/community-clusters-06"
# out_dir <- "D:/Terra-Informatix/Richael-Ghana/Spneumo-WGS/location-clusters-06" #area
out_dir <- "D:/Terra-Informatix/Richael-Ghana/Spneumo-WGS/facility-clusters-06"
...
# trans_lvl = "Community" # Community or "Facility" 

# # Area/location level analysis
# Main_var = "Location"
# Var_01 =  "FacilityCode" #"Facility"
# Var_02 = "SamplingDate"
# clust_type = "Transmission" # Core or Transmission
...
#   # transmission_lvl = "facility" # Facility level analysis will be performed per facility. Facility can be a school, hopsital etc
#   # transmission_lvl = "facility" # Hospital level analysis will be performed per hospital. Ward information should be provided
#   transmission_lvl = clust_type #"community" # Community level analysis will be performed by ST
#   #snpco=11  # set SNP cut-off     (Set to 20 by default)
#   #daysco=14 # Set number of days (set to 14 by default)
#   
# }
# # else{
#   # transmission_lvl = Main_var # Value for Main_var
...
# transmission_lvl = "facility" # Facility level analysis will be performed per facility. Facility can be a school, hopsital etc
# # transmission_lvl = "facility" # Hospital level analysis will be performed per hospital. Ward information should be provided
# # transmission_lvl = "community" # Community level analysis will be performed by ST
# snpco=20  # set SNP cut-off     (Set to 20 by default)
