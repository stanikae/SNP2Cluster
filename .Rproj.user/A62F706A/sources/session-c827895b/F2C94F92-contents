...
out_dir <- "D:/Terra-Informatix/Richael-Ghana/Spneumo-WGS/clusters-02"

# Type of transmission dynamics (Community vs Hopsital)
# transmission_type = "hospital" # Hospital level analysis will be performed per facility
